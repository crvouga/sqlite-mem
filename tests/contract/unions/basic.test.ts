...
const data = ["CREATE TABLE a(v INTEGER)", "CREATE TABLE b(v INTEGER)", "INSERT INTO a VALUES (1),(2),(2),(3)", "INSERT INTO b VALUES (2),(3),(4)"];
...
parity("compound query aliases come from first arm", [], "SELECT 1 AS value UNION ALL SELECT 2 AS ignored ORDER BY value");
